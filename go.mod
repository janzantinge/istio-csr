...
require (
	...
	github.com/envoyproxy/go-control-plane v0.9.10-0.20210527202905-e1f5cab41e70 // indirect
	...
	istio.io/gogo-genproto v0.0.0-20210617140933-c53bf41fad30 // indirect
